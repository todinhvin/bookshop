									...
									<div class="content-inner">
										...
										<div class="switcher-currency">
											...
											<sec:authorize access ="isAnonymous()">
												...
												<div class="switcher-currency-trigger">
													<div class="setting__menu">
														<span><a href="<c:url value='/dang-nhap'/>">Đăng nhập</a></span>
														<span><a href="<c:url value='dang-ky'/>">Đăng ký tài khoản</a></span>
													</div>
												</div>
											</div>
											</sec:authorize>
											<sec:authorize access ="isAuthenticated()">
												...
												<div class="switcher-currency-trigger">
													<div class="setting__menu">
														<span><a href="<c:url value='/thoat'/>">Đăng xuất</a></span>					
													</div>
												</div>
											</div>
											</sec:authorize>
