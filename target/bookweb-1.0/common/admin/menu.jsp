<div class="sidebar sidebar-dark bg-dark">
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="<c:url value ='/quan-tri/danh-sach?page=1&limit=2'/>"><i class="fa fa-fw fa-table"></i>
                        Datatables</a></li>
                <li><a href="https://bootadmin.net/demo/cards"><i class="fa fa-fw fa-address-card"></i> Cards</a></li>
                <li><a href="https://bootadmin.net/demo/calendar"><i class="fa fa-fw fa-calendar-alt"></i> Calendar</a>
                </li>
